...
ALTER SEQUENCE public.address_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.reservation_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.reservation_rating_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.reservations_summary_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.reservations_summary_id_seq1 OWNER TO admin;
...
ALTER SEQUENCE public.sports_facility_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.sports_field_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.sports_field_price_list_id_seq OWNER TO admin;
...
ALTER SEQUENCE public.sports_reservation_report_id_seq OWNER TO admin;
...
CREATE TABLE public."user" (
    ...
    fiscal_code character varying(100)
);
...
1	italia	napoli	via benedetto brin	69	80134
2	italia	napoli	via benedetto brin	70	80134
3	italia	napoli	via benedetto brin	71	80134
\.
...
1	1	1	2023-04-22 13:00:00	2023-04-22 14:00:00	2023-04-21 10:00:00	pending	0
2	1	2	2023-04-23 13:00:00	2023-04-23 14:00:00	2023-04-21 10:00:00	pending	0
3	1	3	2023-04-24 13:00:00	2023-04-24 14:00:00	2023-04-21 10:00:00	pending	0
\.
...
1	1	Fervento	10	1	02828382383
2	2	Fervento2	11	1	02228382383
3	3	Fervento3	12	1	02328382383
\.
...
1	1	soccer 5 field	soccer	t	1	1	5	4
2	2	soccer 5 field	soccer	t	2	1	5	4
3	3	soccer 5 field	soccer	t	3	1	5	4
\.
...
1	luca	bianco	1	lucabianco@fervento	luca	bianco	lslslslslsl
2	lorenzo	destriere	2	lorenzodestriere@fervento	lorenzo	destriere	ldldlldldld
3	fabio	bianco	3	fabiobianco@fervento	fabio	bianco	fsfsfslsffsl
\.
...
SELECT pg_catalog.setval('public.sports_facility_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.sports_field_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.sports_field_price_list_id_seq', 3, true);
